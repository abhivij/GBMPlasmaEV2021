...
results_dir = "fem_pipeline_results_pr_val_from_initial_combat_subset"
dataset_replace_string = "validation_GBM_initial_proteomic_common_combat_PREOPEVsPOSTOPE_TP_"
dir_path = "plots/fem_pipeline_results_pr_val_from_initial_combat/common_heatmap/"
...
plot_common_feature_heatmap(c(81),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_proteomic,
                            results_dir = "fem_pipeline_results_proteomic_common_combat_subset",
                            dataset_replace_string = "GBM_initial_proteomic_common_combat_POSTOPE_TPVsREC_TP_",
                            dir_path = "plots/FEMPipeline_prot_common_combat/common_heatmap/",
                            heatmap_file_name = "POSTOPE_TPVsREC_TP.png"
)
plot_common_feature_heatmap(c(82, 83),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_proteomic,
                            results_dir = "fem_pipeline_results_proteomic_common_combat_subset",
                            dataset_replace_string = "GBM_initial_proteomic_common_combat_PREOPEVsPOSTOPE_TP_",
                            dir_path = "plots/FEMPipeline_prot_common_combat/common_heatmap/",
                            heatmap_file_name = "PREOPEVsPOSTOPE_TP.png"
)
plot_common_feature_heatmap(c(84),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_proteomic,
                            results_dir = "fem_pipeline_results_proteomic_common_combat_subset",
                            dataset_replace_string = "GBM_initial_proteomic_common_combat_PREOPEVsREC_TP_",
                            dir_path = "plots/FEMPipeline_prot_common_combat/common_heatmap/",
                            heatmap_file_name = "PREOPEVsREC_TP.png"
)
...
plot_common_feature_heatmap(c(67, 68),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_transcriptomic,
                            results_dir = "fem_pipeline_results_tr_common_combat_subset",
                            dataset_replace_string = "GBM_initial_transcriptomic_common_combat_POSTOPE_TPVsREC_TP_",
                            dir_path = "plots/FEMPipeline_tr_common_combat/common_heatmap/",
                            heatmap_file_name = "POSTOPE_TPVsREC_TP.png"
)

plot_common_feature_heatmap(c(69, 70),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_transcriptomic,
                            results_dir = "fem_pipeline_results_tr_common_combat_subset",
                            dataset_replace_string = "GBM_initial_transcriptomic_common_combat_PREOPEVsPOSTOPE_TP_",
                            dir_path = "plots/FEMPipeline_tr_common_combat/common_heatmap/",
                            heatmap_file_name = "PREOPEVsPOSTOPE_TP.png"
)

plot_common_feature_heatmap(c(71:74),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_transcriptomic,
                            results_dir = "fem_pipeline_results_tr_common_combat_subset",
                            dataset_replace_string = "GBM_initial_transcriptomic_common_combat_PREOPEVsREC_TP_",
                            dir_path = "plots/FEMPipeline_tr_common_combat/common_heatmap/",
                            heatmap_file_name = "PREOPEVsREC_TP.png"
)
...
plot_common_feature_heatmap(c(75:78),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_transcriptomic,
                            results_dir = "fem_pipeline_results_tr_common_subset",
                            dataset_replace_string = "GBM_initial_transcriptomic_common_POSTOPE_TPVsREC_TP_",
                            dir_path = "plots/FEMPipeline_tr_common/common_heatmap/",
                            heatmap_file_name = "POSTOPE_TPVsREC_TP.png"
)
plot_common_feature_heatmap(c(79:82),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_transcriptomic,
                            results_dir = "fem_pipeline_results_tr_common_subset",
                            dataset_replace_string = "GBM_initial_transcriptomic_common_PREOPEVsPOSTOPE_TP_",
                            dir_path = "plots/FEMPipeline_tr_common/common_heatmap/",
                            heatmap_file_name = "PREOPEVsPOSTOPE_TP.png"
)
plot_common_feature_heatmap(c(83:84),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_transcriptomic,
                            results_dir = "fem_pipeline_results_tr_common_subset",
                            dataset_replace_string = "GBM_initial_transcriptomic_common_PREOPEVsREC_TP_",
                            dir_path = "plots/FEMPipeline_tr_common/common_heatmap/",
                            heatmap_file_name = "PREOPEVsREC_TP.png"
)
...
plot_heatmap(
  dparg_vec = c(85, 89, 93),
  dataset_pipeline_arguments = dataset_pipeline_arguments_proteomic,
  results_dir = "fem_pipeline_results_combined_pr_common_combat",
  dir_path = "plots/fem_pipeline_combined_pr/",
...
plot_heatmap(
  dparg_vec = c(97, 101, 105),
  dataset_pipeline_arguments = dataset_pipeline_arguments_proteomic,
  results_dir = "fem_pipeline_results_val_pr_common_combat",
  dir_path = "plots/fem_pipeline_val_combat_pr/",
  dataset_replace_string = "GBM_validation_proteomic_common_combat_"
)

plot_common_feature_heatmap(c(151),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_proteomic,
                            results_dir = "fem_pipeline_results_val_pr_common_combat_subset",
                            dataset_replace_string = "GBM_validation_proteomic_common_combat_POSTOPE_TPVsREC_TP_",
                            dir_path = "plots/fem_pipeline_val_combat_pr/common_heatmap/",
                            heatmap_file_name = "POSTOPE_TPVsREC_TP.png"
)
plot_common_feature_heatmap(c(152),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_proteomic,
                            results_dir = "fem_pipeline_results_val_pr_common_combat_subset",
                            dataset_replace_string = "GBM_validation_proteomic_common_combat_PREOPEVsPOSTOPE_TP_",
                            dir_path = "plots/fem_pipeline_val_combat_pr/common_heatmap/",
                            heatmap_file_name = "PREOPEVsPOSTOPE_TP.png"
)
plot_common_feature_heatmap(c(153),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_proteomic,
                            results_dir = "fem_pipeline_results_val_pr_common_combat_subset",
                            dataset_replace_string = "GBM_validation_proteomic_common_combat_PREOPEVsREC_TP_",
                            dir_path = "plots/fem_pipeline_val_combat_pr/common_heatmap/",
                            heatmap_file_name = "PREOPEVsREC_TP.png"
)
...
plot_heatmap(
  dparg_vec = c(109, 113, 117),
  dataset_pipeline_arguments = dataset_pipeline_arguments_proteomic,
  results_dir = "fem_pipeline_results_validation_pr_common",
  dir_path = "plots/fem_pipeline_val_pr/",
  dataset_replace_string = "GBM_validation_proteomic_common_"
)

plot_common_feature_heatmap(c(148),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_proteomic,
                            results_dir = "fem_pipeline_results_validation_pr_common_subset",
                            dataset_replace_string = "GBM_validation_proteomic_common_POSTOPE_TPVsREC_TP_",
                            dir_path = "plots/fem_pipeline_val_pr/common_heatmap/",
                            heatmap_file_name = "POSTOPE_TPVsREC_TP.png"
)
plot_common_feature_heatmap(c(149),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_proteomic,
                            results_dir = "fem_pipeline_results_validation_pr_common_subset",
                            dataset_replace_string = "GBM_validation_proteomic_common_PREOPEVsPOSTOPE_TP_",
                            dir_path = "plots/fem_pipeline_val_pr/common_heatmap/",
                            heatmap_file_name = "PREOPEVsPOSTOPE_TP.png"
)
plot_common_feature_heatmap(c(150),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_proteomic,
                            results_dir = "fem_pipeline_results_validation_pr_common_subset",
                            dataset_replace_string = "GBM_validation_proteomic_common_PREOPEVsREC_TP_",
                            dir_path = "plots/fem_pipeline_val_pr/common_heatmap/",
                            heatmap_file_name = "PREOPEVsREC_TP.png"
)
####################
...
plot_heatmap(
  dparg_vec = c(55, 59, 63),
  dataset_pipeline_arguments = dataset_pipeline_arguments_transcriptomic,
  results_dir = "fem_pipeline_results_validation_tr_common_combat",
  dir_path = "plots/fem_pipeline_val_combat_tr/",
  dataset_replace_string = "GBM_validation_transcriptomic_common_combat_"
)

plot_common_feature_heatmap(c(133:134),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_transcriptomic,
                            results_dir = "fem_pipeline_results_validation_tr_common_combat_subset",
                            dataset_replace_string = "GBM_validation_transcriptomic_common_combat_POSTOPE_TPVsREC_TP_",
                            dir_path = "plots/fem_pipeline_val_combat_tr/common_heatmap/",
                            heatmap_file_name = "POSTOPE_TPVsREC_TP.png"
)
plot_common_feature_heatmap(c(135),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_transcriptomic,
                            results_dir = "fem_pipeline_results_validation_tr_common_combat_subset",
                            dataset_replace_string = "GBM_validation_transcriptomic_common_combat_PREOPEVsPOSTOPE_TP_",
                            dir_path = "plots/fem_pipeline_val_combat_tr/common_heatmap/",
                            heatmap_file_name = "PREOPEVsPOSTOPE_TP.png"
)
plot_common_feature_heatmap(c(136:137),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_transcriptomic,
                            results_dir = "fem_pipeline_results_validation_tr_common_combat_subset",
                            dataset_replace_string = "GBM_validation_transcriptomic_common_combat_PREOPEVsREC_TP_",
                            dir_path = "plots/fem_pipeline_val_combat_tr/common_heatmap/",
                            heatmap_file_name = "PREOPEVsREC_TP.png"
)
####################
...
plot_heatmap(
  ...
  dir_path = "plots/fem_pipeline_val_tr/",
  dataset_replace_string = "GBM_validation_transcriptomic_common_"
)

plot_common_feature_heatmap(c(127:128),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_transcriptomic,
                            results_dir = "fem_pipeline_results_validation_tr_common_subset",
                            dataset_replace_string = "GBM_validation_transcriptomic_common_POSTOPE_TPVsREC_TP_",
                            dir_path = "plots/fem_pipeline_val_tr/common_heatmap/",
                            heatmap_file_name = "POSTOPE_TPVsREC_TP.png"
)
plot_common_feature_heatmap(c(129:130),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_transcriptomic,
                            results_dir = "fem_pipeline_results_validation_tr_common_subset",
                            dataset_replace_string = "GBM_validation_transcriptomic_common_PREOPEVsPOSTOPE_TP_",
                            dir_path = "plots/fem_pipeline_val_tr/common_heatmap/",
                            heatmap_file_name = "PREOPEVsPOSTOPE_TP.png"
)
plot_common_feature_heatmap(c(131:132),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_transcriptomic,
                            results_dir = "fem_pipeline_results_validation_tr_common_subset",
                            dataset_replace_string = "GBM_validation_transcriptomic_common_PREOPEVsREC_TP_",
                            dir_path = "plots/fem_pipeline_val_tr/common_heatmap/",
                            heatmap_file_name = "PREOPEVsREC_TP.png"
)


#validation proteomics with initial cohort biomarkers
plot_common_feature_heatmap(c(154),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_proteomic,
                            results_dir = "fem_pipeline_results_pr_val_from_initial_combat_subset",
                            dataset_replace_string = "validation_GBM_initial_proteomic_common_combat_POSTOPE_TPVsREC_TP_",
                            dir_path = "plots/fem_pipeline_results_pr_val_from_initial_combat/common_heatmap/",
                            heatmap_file_name = "POSTOPE_TPVsREC_TP.png"
)
plot_common_feature_heatmap(c(155),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_proteomic,
                            results_dir = "fem_pipeline_results_pr_val_from_initial_combat_subset",
                            dataset_replace_string = "validation_GBM_initial_proteomic_common_combat_PREOPEVsPOSTOPE_TP_",
                            dir_path = "plots/fem_pipeline_results_pr_val_from_initial_combat/common_heatmap/",
...
plot_common_feature_heatmap(c(156),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_proteomic,
                            results_dir = "fem_pipeline_results_pr_val_from_initial_combat_subset",
                            dataset_replace_string = "validation_GBM_initial_proteomic_common_combat_PREOPEVsREC_TP_",
                            dir_path = "plots/fem_pipeline_results_pr_val_from_initial_combat/common_heatmap/",
                            heatmap_file_name = "PREOPEVsREC_TP.png"
)


#validation transcriptomics with initial cohort biomarkers
plot_common_feature_heatmap(c(138),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_transcriptomic,
                            results_dir = "fem_pipeline_results_tr_val_from_initial_combat_subset",
                            dataset_replace_string = "validation_GBM_initial_transcriptomic_common_combat_POSTOPE_TPVsREC_TP_",
                            dir_path = "plots/fem_pipeline_results_tr_val_from_initial_combat/common_heatmap/",
                            heatmap_file_name = "POSTOPE_TPVsREC_TP.png"
)
plot_common_feature_heatmap(c(139),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_transcriptomic,
                            results_dir = "fem_pipeline_results_tr_val_from_initial_combat_subset",
                            dataset_replace_string = "validation_GBM_initial_transcriptomic_common_combat_PREOPEVsPOSTOPE_TP_",
                            dir_path = "plots/fem_pipeline_results_tr_val_from_initial_combat/common_heatmap/",
                            heatmap_file_name = "PREOPEVsPOSTOPE_TP.png"
)
plot_common_feature_heatmap(c(140),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_transcriptomic,
                            results_dir = "fem_pipeline_results_tr_val_from_initial_combat_subset",
                            dataset_replace_string = "validation_GBM_initial_transcriptomic_common_combat_PREOPEVsREC_TP_",
                            dir_path = "plots/fem_pipeline_results_tr_val_from_initial_combat/common_heatmap/",
                            heatmap_file_name = "PREOPEVsREC_TP.png"
)
...
#proteomic common combat mod

plot_heatmap(
  dparg_vec = c(121, 125, 129),
  dataset_pipeline_arguments = dataset_pipeline_arguments_proteomic,
  results_dir = "fem_pipeline_results_pr_common_combat_mod",
  dir_path = "plots/fempipeline_prot_common_combat_mod/",
  dataset_replace_string = "GBM_initial_proteomic_common_combat_mod_"
)

plot_common_feature_heatmap(c(157, 158),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_proteomic,
                            results_dir = "fem_pipeline_results_pr_common_combat_mod_subset",
                            dataset_replace_string = "GBM_initial_proteomic_common_combat_mod_POSTOPE_TPVsREC_TP_",
                            dir_path = "plots/fempipeline_prot_common_combat_mod/common_heatmap/",
                            heatmap_file_name = "POSTOPE_TPVsREC_TP.png"
)
plot_common_feature_heatmap(c(159, 160),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_proteomic,
                            results_dir = "fem_pipeline_results_pr_common_combat_mod_subset",
                            dataset_replace_string = "GBM_initial_proteomic_common_combat_mod_PREOPEVsPOSTOPE_TP_",
                            dir_path = "plots/fempipeline_prot_common_combat_mod/common_heatmap/",
                            heatmap_file_name = "PREOPEVsPOSTOPE_TP.png"
)
plot_common_feature_heatmap(c(161),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_proteomic,
                            results_dir = "fem_pipeline_results_pr_common_combat_mod_subset",
                            dataset_replace_string = "GBM_initial_proteomic_common_combat_mod_PREOPEVsREC_TP_",
                            dir_path = "plots/fempipeline_prot_common_combat_mod/common_heatmap/",
                            heatmap_file_name = "PREOPEVsREC_TP.png"
)
...
#transcriptomic common combat mod

plot_heatmap(
  dparg_vec = c(97, 101, 105),
  dataset_pipeline_arguments = dataset_pipeline_arguments_transcriptomic,
  results_dir = "fem_pipeline_results_tr_common_combat_mod",
  dir_path = "plots/fempipeline_tr_common_combat_mod/",
  dataset_replace_string = "GBM_initial_transcriptomic_common_combat_mod_"
)

plot_common_feature_heatmap(c(141:144),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_transcriptomic,
                            results_dir = "fem_pipeline_results_tr_common_combat_mod_subset",
                            dataset_replace_string = "GBM_initial_transcriptomic_common_combat_mod_POSTOPE_TPVsREC_TP_",
                            dir_path = "plots/fempipeline_tr_common_combat_mod/common_heatmap/",
                            heatmap_file_name = "POSTOPE_TPVsREC_TP.png"
)

plot_common_feature_heatmap(c(145:146),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_transcriptomic,
                            results_dir = "fem_pipeline_results_tr_common_combat_mod_subset",
                            dataset_replace_string = "GBM_initial_transcriptomic_common_combat_mod_PREOPEVsPOSTOPE_TP_",
                            dir_path = "plots/fempipeline_tr_common_combat_mod/common_heatmap/",
                            heatmap_file_name = "PREOPEVsPOSTOPE_TP.png"
)
...
plot_common_feature_heatmap(c(147),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_transcriptomic,
                            results_dir = "fem_pipeline_results_tr_common_combat_mod_subset",
                            dataset_replace_string = "GBM_initial_transcriptomic_common_combat_mod_PREOPEVsREC_TP_",
                            dir_path = "plots/fempipeline_tr_common_combat_mod/common_heatmap/",
                            heatmap_file_name = "PREOPEVsREC_TP.png"
)
...
plot_heatmap(
  ...
  dir_path = "plots/fem_pipeline_combined_pr_combat_mod/",
  dataset_replace_string = "GBM_combined_proteomic_common_combat_mod_"
)

plot_common_feature_heatmap(c(162),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_proteomic,
                            results_dir = "fem_pipeline_results_combined_pr_common_combat_mod_subset",
                            dataset_replace_string = "GBM_combined_proteomic_common_combat_mod_POSTOPE_TPVsREC_TP_",
                            dir_path = "plots/fem_pipeline_combined_pr_combat_mod/common_heatmap/",
                            heatmap_file_name = "POSTOPE_TPVsREC_TP.png"
)
plot_common_feature_heatmap(c(163),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_proteomic,
                            results_dir = "fem_pipeline_results_combined_pr_common_combat_mod_subset",
                            dataset_replace_string = "GBM_combined_proteomic_common_combat_mod_PREOPEVsPOSTOPE_TP_",
                            dir_path = "plots/fem_pipeline_combined_pr_combat_mod/common_heatmap/",
                            heatmap_file_name = "PREOPEVsPOSTOPE_TP.png"
)
plot_common_feature_heatmap(c(164),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_proteomic,
                            results_dir = "fem_pipeline_results_combined_pr_common_combat_mod_subset",
                            dataset_replace_string = "GBM_combined_proteomic_common_combat_mod_PREOPEVsREC_TP_",
                            dir_path = "plots/fem_pipeline_combined_pr_combat_mod/common_heatmap/",
                            heatmap_file_name = "PREOPEVsREC_TP.png"
)
...
plot_heatmap(
  ...
  dir_path = "plots/fem_pipeline_combined_tr_combat_mod/",
  dataset_replace_string = "GBM_combined_transcriptomic_common_combat_mod_"
)

plot_common_feature_heatmap(c(148, 149),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_transcriptomic,
                            results_dir = "fem_pipeline_results_combined_tr_common_combat_mod_subset",
                            dataset_replace_string = "GBM_combined_transcriptomic_common_combat_mod_POSTOPE_TPVsREC_TP_",
                            dir_path = "plots/fem_pipeline_combined_tr_combat_mod/common_heatmap/",
                            heatmap_file_name = "POSTOPE_TPVsREC_TP.png"
)
plot_common_feature_heatmap(c(150),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_transcriptomic,
                            results_dir = "fem_pipeline_results_combined_tr_common_combat_mod_subset",
                            dataset_replace_string = "GBM_combined_transcriptomic_common_combat_mod_PREOPEVsPOSTOPE_TP_",
                            dir_path = "plots/fem_pipeline_combined_tr_combat_mod/common_heatmap/",
                            heatmap_file_name = "PREOPEVsPOSTOPE_TP.png"
)
plot_common_feature_heatmap(c(151, 152),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_transcriptomic,
                            results_dir = "fem_pipeline_results_combined_tr_common_combat_mod_subset",
                            dataset_replace_string = "GBM_combined_transcriptomic_common_combat_mod_PREOPEVsREC_TP_",
                            dir_path = "plots/fem_pipeline_combined_tr_combat_mod/common_heatmap/",
                            heatmap_file_name = "PREOPEVsREC_TP.png"
)
...
plot_heatmap(
  dparg_vec = c(165, 169, 173),
  dataset_pipeline_arguments = dataset_pipeline_arguments_proteomic,
  results_dir = "fem_pipeline_results_combined_proteomic_combat_compset2",
  dir_path = "plots_comparison_set2/fem_pipeline_results_combined_proteomic_combat_compset2/",
...
plot_common_feature_heatmap(c(165:169),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_transcriptomic,
                            results_dir = "fem_pipeline_results_combined_transcriptomic_combat_compset2_subset",
                            dataset_replace_string = "GBM_combined_transcriptomic_combat_compset2_PREOPEVsMET_",
                            dir_path = "plots_comparison_set2/fem_pipeline_results_combined_transcriptomic_combat_compset2/common_heatmap/",
                            heatmap_file_name = "PREOPEVsMET.png"
)
plot_common_feature_heatmap(c(170:173),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_transcriptomic,
                            results_dir = "fem_pipeline_results_combined_transcriptomic_combat_compset2_subset",
                            dataset_replace_string = "GBM_combined_transcriptomic_combat_compset2_PREOPEVsHC_",
                            dir_path = "plots_comparison_set2/fem_pipeline_results_combined_transcriptomic_combat_compset2/common_heatmap/",
                            heatmap_file_name = "PREOPEVsHC.png"
)
plot_common_feature_heatmap(c(174:181),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_transcriptomic,
                            results_dir = "fem_pipeline_results_combined_transcriptomic_combat_compset2_subset",
                            dataset_replace_string = "GBM_combined_transcriptomic_combat_compset2_METVsHC_",
                            dir_path = "plots_comparison_set2/fem_pipeline_results_combined_transcriptomic_combat_compset2/common_heatmap/",
                            heatmap_file_name = "METVsHC.png"
)
...
plot_common_feature_heatmap(c(207:208),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_proteomic,
                            results_dir = "fem_pipeline_results_combined_proteomic_compset2_subset",
                            dataset_replace_string = "GBM_combined_proteomic_compset2_",
                            dir_path = "plots_comparison_set2/fem_pipeline_results_combined_proteomic_compset2/common_heatmap/",
                            heatmap_file_name = "PREOPEVsMET.png"
)
plot_common_feature_heatmap(c(209:210),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_proteomic,
                            results_dir = "fem_pipeline_results_combined_proteomic_compset2_subset",
                            dataset_replace_string = "GBM_combined_proteomic_compset2_",
                            dir_path = "plots_comparison_set2/fem_pipeline_results_combined_proteomic_compset2/common_heatmap/",
...
plot_common_feature_heatmap(c(211:212),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_proteomic,
                            results_dir = "fem_pipeline_results_combined_proteomic_compset2_subset",
                            dataset_replace_string = "GBM_combined_proteomic_compset2_",
                            dir_path = "plots_comparison_set2/fem_pipeline_results_combined_proteomic_compset2/common_heatmap/",
...
plot_common_feature_heatmap(c(226:227),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_transcriptomic,
                            results_dir = "fem_pipeline_results_combined_transcriptomic_new_quant_DE_compset2_subset",
                            dataset_replace_string = "GBM_combined_transcriptomic_new_quant_DE_compset2_PREOPEVsMET_",
                            dir_path = "plots_comparison_set2/fem_pipeline_results_combined_transcriptomic_new_quant_DE_compset2/common_heatmap/",
                            heatmap_file_name = "PREOPEVsMET.png"
)
plot_common_feature_heatmap(c(228:229),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_transcriptomic,
                            results_dir = "fem_pipeline_results_combined_transcriptomic_new_quant_DE_compset2_subset",
                            dataset_replace_string = "GBM_combined_transcriptomic_new_quant_DE_compset2_PREOPEVsHC_",
                            dir_path = "plots_comparison_set2/fem_pipeline_results_combined_transcriptomic_new_quant_DE_compset2/common_heatmap/",
                            heatmap_file_name = "PREOPEVsHC.png"
)
plot_common_feature_heatmap(c(230:234),
                            dataset_pipeline_arguments = dataset_pipeline_arguments_transcriptomic,
                            results_dir = "fem_pipeline_results_combined_transcriptomic_new_quant_DE_compset2_subset",
                            dataset_replace_string = "GBM_combined_transcriptomic_new_quant_DE_compset2_METVsHC_",
                            dir_path = "plots_comparison_set2/fem_pipeline_results_combined_transcriptomic_new_quant_DE_compset2/common_heatmap/",
                            heatmap_file_name = "METVsHC.png"
)
