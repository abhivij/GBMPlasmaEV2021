perform_de_comparisons_arglist <- list(
  ...
  #8
  list(file_name = "data_process_output_annotatedQ1-6_NA_quantile.rds", 
       comparison_list = list(c("PREOPE", "MET"),
                              c("PREOPE", "HC"),
                              c("MET", "HC")), 
       comparison_num = "2"),  
  ...
  #13
  list(file_name = "data_process_output_annotatedQ7_NA_quantile.rds", 
       comparison_list = list(c("PREOPE", "REC-TP")), 
       comparison_num = "7"),

  #14
  list(file_name = "data_process_output_annotatedQ1-6_NA_remove_50_missing_quantile.rds", 
       comparison_list = list(c("PREOPE", "MET"),
                              c("PREOPE", "HC"),
                              c("MET", "HC")), 
       comparison_num = "2")    
